    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-16">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh]">
            ...
            <div className="relative mb-8 lg:mb-0">
              <div className="bg-secondary rounded-full p-8 w-80 h-80 mx-auto flex items-center justify-center text-white text-center shadow-2xl">
                <div>
                  ...
                  <p className="bg-red-600 text-white px-4 py-2 rounded-full text-sm font-semibold">
          ...
          {/* Contenu principal */}
          <header className="lg:w-1/2 text-center lg:text-left lg:pl-12">
            <h1
              id="hero-title"
              className="text-5xl lg:text-6xl font-bold mb-6 text-white leading-tight"
            >
              Festival du Numérique et de l&apos;Innovation d&apos;Occitanie
            </h1>

            <div className="mb-6">
              <p className="text-secondary text-xl font-semibold mb-2">
                TOULOUSE & EN LIGNE
              </p>
              <time
                className="text-secondary text-2xl font-bold"
                dateTime="2025-09-22/2025-09-27"
              >
            ...
            <div className="space-y-4">
              <Button
                ...
                aria-label="S'inscrire gratuitement au festival La Mêlée Numérique"
              >
              ...
              <a
                ...
                aria-label="Voir la vidéo explicative sur YouTube, attention il s'agit d'un Rickroll"
                title="Lien vers une vidéo YouTube Rickroll"
              >
                Voir la vidéo explicative sur YouTube (attention, ce lien mène vers un Rickroll)
              </a>
            </div>
          </header>
        </div>
